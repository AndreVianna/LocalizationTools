...
public static class ServiceCollectionExtensions {
    public static IServiceCollection AddPostgreSqlLocalizationProvider(this IServiceCollection services, string applicationId, string connectionString, Action<NpgsqlDbContextOptionsBuilder>? optionsBuilder = null) {
